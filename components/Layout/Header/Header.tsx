...
import { Menu, X, Home, Briefcase, Grid, LayoutGrid, Users, Phone, MessageSquare } from "lucide-react";
...
const Header = () => {
  ...
  const navLinks = [
    ...
    { key: "services", href: `/${currentLocale}/services`, icon: <Briefcase size={20} /> },
    { key: "businessSolutions", href: `/${currentLocale}/businessSolutions`, icon: <Grid size={20} /> },
    { key: "portfolio", href: `/${currentLocale}/portfolio`, icon: <LayoutGrid size={20} /> },
    { key: "aboutus", href: `/${currentLocale}/aboutus`, icon: <Users size={20} /> },
    { key: "contact", href: `/${currentLocale}/contact`, icon: <Phone size={20} /> },
  ];
          ...
          <div className={styles.scrollableContainer}>
            ...
            <div className={styles.mobileDrawerFooter}>
              ...
              <div className={styles.contactCards}>
                <a href="tel:+971586651844" className={styles.contactCard}>
                  ...
                  <div className={styles.contactInfo}>
                    ...
                    <span className={styles.contactValue}>+971 58 665 1844</span>
                  </div>
                </a>
              ...
              <div className={styles.socialIcons}>
                <a href="https://linkedin.com/company/axuraa" target="_blank" rel="noopener noreferrer" className={styles.socialIcon}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect width="4" height="12" x="2" y="9"></rect><circle cx="4" cy="4" r="2"></circle></svg>
                </a>
                <a href="https://instagram.com/axuraa" target="_blank" rel="noopener noreferrer" className={styles.socialIcon}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"></line></svg>
                </a>
                <a href="https://facebook.com/axuraa" target="_blank" rel="noopener noreferrer" className={styles.socialIcon}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
                </a>
                <a href="https://twitter.com/axuraa" target="_blank" rel="noopener noreferrer" className={styles.socialIcon}>
