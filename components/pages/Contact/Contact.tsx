...
// Create a stable mapping object outside the component
const ICON_MAPPING: Record<string, React.FC<React.SVGProps<SVGSVGElement>>> = {
...
const Contact = () => {
  ...
  const socialPlatforms = useMemo((): SocialMediaPlatform[] => {
    ...
    console.log('Platform icons:', platforms.map((p: { name: any; icon: { name: any; }; }) => ({ name: p.name, iconName: p.icon.name })));
